...
namespace CibertecAPI
{
    public class Startup
    {
        ...
        {
            //como JSONP . Este tema muestra cómo habilitar CORS en una aplicación ASP.NET Core.  06/01/2018
        ...
        public void Configure(IApplicationBuilder app, IHostingEnvironment env, ILoggerFactory loggerFactory)
        {
            ...
            app.UseCors("CorsPolicy"); //puede permitir explícitamente algunas solicitudes de origen cruzado y rechazar otras 06/01/2018
